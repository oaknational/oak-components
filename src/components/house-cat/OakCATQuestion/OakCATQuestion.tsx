...
import { InternalUnstyledChevronAccordion } from "@/components/internal-components/InternalUnstyledChevronAccordion";
...
export const OakCATQuestion = (props: OakCATQuestionProps) => {
  ...
  const body = (
    <OakFlex $flexDirection={"column"} $width={"100%"} $mt={"spacing-24"}>
