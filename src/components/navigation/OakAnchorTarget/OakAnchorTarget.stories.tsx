...
import { InternalCard } from "@/components/internal-components/InternalCard";
import {
  OakAnchorTarget,
  OakAnchorTargetProps,
} from "@/components/navigation/OakAnchorTarget";

const meta: Meta<typeof OakAnchorTarget> = {
  component: OakAnchorTarget,
  tags: ["autodocs"],
  title: "components/Navigation/OakAnchorTarget",
  parameters: {
    controls: {
      include: [],
    },
