...
import { oakBoxCss } from "@/components/layout-and-structure/OakBox";
import { OakFlexProps } from "@/components/layout-and-structure/OakFlex";
 ...
 *
 **/
export const oakLIDefaults = {
  $display: "revert",
} satisfies Partial<OakLIProps>;
