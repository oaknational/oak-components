...
There is a component template in the components library called CopyPasteThisComponent

You can copy this component and replace the name with the name of your new component.

It has the index, component, story and test file in the folder so you just have to adapt it to your component.
