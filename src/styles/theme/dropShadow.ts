...
export const oakDropShadowTokens = {
  ...
  "drop-shadow-yellow": `0.125rem 0.125rem 0 ${parseColor("lemon")}`,
  "drop-shadow-wide-yellow": `0.25rem 0.25rem 0 ${parseColor("lemon")}`,
  "drop-shadow-centered-yellow": `0 0 0 0.125rem ${parseColor("lemon")}`,
