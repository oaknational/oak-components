...
import { OakAllSpacing, oakAllSpacingPx, OakColor } from "@/styles/tokens";

// //import renderWithTheme from "../../__tests__/__helpers__/renderWithTheme";

type TestProps = Record<string, OakAllSpacing | OakAllSpacing[]>;
/**
 *
...
const allSpacingToPx = (value: OakAllSpacing) =>
  oakAllSpacingPx[value] ? `${oakAllSpacingPx[value]}px` : undefined;
...
describe("responsive", () => {
  it("should correctly handle a single value", async () => {
    ...
    const { getByTestId } = render(
      <StyledComponent data-testid="test" $pl={"all-spacing-12"} />,
    );

    expect(getByTestId("test")).toHaveStyle("padding-left: 72px");
  });
